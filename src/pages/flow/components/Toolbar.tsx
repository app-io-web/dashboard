...
export default function Toolbar({
  ...
  useEffect(() => {
    ...
    // 🔥 sem onAppDetected pra evitar loop
  ...
  return (
    <div className="bg-white border-b border-gray-200 px-4 py-3 md:px-6 md:py-4">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        {/* Esquerda: voltar + título + info app */}
        ...
        {/* Direita: botões – empilhados no mobile, lado a lado no desktop */}
        <div className="flex flex-col gap-2 w-full md:w-auto md:flex-row md:items-center md:justify-end">
          {flowId && empresaId && (
            <button
              onClick={goToSettings}
              className="w-full md:w-auto text-blue-600 hover:text-blue-800 text-sm font-medium"
            >
              Configurações
            </button>
          )}
